...
import PostBox from "../assets/svgs/invitepage-promote.svg";
...
const Invite = () => {
        ...
        return (
            <div className={'flex flex-col h-full overflow-y-scroll justify-start items-center'}>
                <ToastContainer/>
                ...
                <div className={'IranSansMedium mt-5 text-textDark text-center'}>
                ...
                <div className={'w-52 h-20 mt-5 bg-white rounded-2xl shadow flex flex-row justify-around items-center'}>
                    <div className={'h-14 w-10 flex flex-col justify-center items-center relative'}>
                    ...
                    <div className={'w-10 h-10  '} onClick={() => {
                        navigator.clipboard.writeText(refCode).then(e => {
