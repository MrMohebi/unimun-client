    ...
    return (
        <div>
            ...
            <div style={{background: '#F6F8FA'}}>
                ...
                <div className={"adsCard d-flex flex-row justify-content-between align-items-center"}>
                    <div className={"d-flex flex-row"}>
                        <div className={" d-flex flex-column"}>
                            ...
                            <div>
                                ...
                                <p>23</p><p>|</p><p>4 ساعت پیش</p>
                            </div>
                        </div>
                        <div className={"d-flex flex-column align-items-end align-content-between justify-content-between h-100"}>
                            <h6 className={"IranSansBold"}>
                                عنوان آگهی
                            </h6>
                            <span className={"IranSansMedium ad-category"}>
                            موضوع آگهی
                        </span>
                            <span className={"IranSansBold mt-auto ad-price"} style={{fontSize:"0.7em"}} >
                            بدون محدودیت
                        </span>
