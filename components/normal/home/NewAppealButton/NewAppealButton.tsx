        ...
        <div className={`fixed bottom-20 right-5  transition-all duration-300`}>
            <div
                ...
                <Button rippleColor={'rgba(0,0,0,0.26)'}
                        className={` transition-all duration-150 h-16 bg-white rounded-2xl shadow-lg flex flex-row justify-around items-center px-2 IranSansMedium`}>
                    <div className={'w-5 h-5 mx-2'}><AddSvg/></div>
                    <span className={`${props.hidden?'w-0':'w-24'} overflow-hidden whitespace-nowrap transition-all duration-100 `}>
                    افزودن آگهی
                </span>
                </Button>
            </div>
